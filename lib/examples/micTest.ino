...
INMP441 RecorderHW(MIC_PIN_SCK, MIC_PIN_WS, MIC_PIN_DIN);
Recorder recorder(sdCard, RecorderHW);
...
void setup() {
  ...
  const char *result = recorder.recordFiveMinutesToFile("/recording-with-sensors-no-cuts-maybee.wav");
